...
class TestElementsSync:
    def test_get_by_path(self, sync_client):
        ...
        elem = client.elements.get_by_path(r"\\AF\Production\Pump-001")
    ...
    def test_delete(self, sync_client):
        ...
        client.elements.delete(ELEM_WEB_ID)
        assert route.called
